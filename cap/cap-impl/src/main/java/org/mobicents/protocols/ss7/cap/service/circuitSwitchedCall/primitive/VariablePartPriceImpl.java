 ...
 *
 */
public class VariablePartPriceImpl extends OctetStringBase implements
        VariablePartPrice, CAPAsnPrimitive {
    ...
    public VariablePartPriceImpl(byte[] data) {
        // this.data = data;
        super(4, 4, "VariablePartPrice", data);
    }
    ...
    public VariablePartPriceImpl(double price) {
        ...
        if (val < 0)
            val = -val;
        this.data[0] = (byte) this
                .encodeByte((int) (val / 1000000 - (val / 100000000) * 100));
        this.data[1] = (byte) this
                .encodeByte((int) (val / 10000 - (val / 1000000) * 100));
        this.data[2] = (byte) this
                .encodeByte((int) (val / 100 - (val / 10000) * 100));
    ...
    public double getPrice() {
        ...
        double res = this.decodeByte(data[0]) * 10000
                + this.decodeByte(data[1]) * 100 + this.decodeByte(data[2])
    ...
    public int getPriceIntegerPart() {
        ...
        int res = this.decodeByte(data[0]) * 10000 + this.decodeByte(data[1])
                * 100 + this.decodeByte(data[2]);
        return res;
    }
    ...
    protected static final XMLFormat<VariablePartPriceImpl> VARIABLE_PART_PRICE_XML = new XMLFormat<VariablePartPriceImpl>(
        ...
        public void read(javolution.xml.XMLFormat.InputElement xml,
                VariablePartPriceImpl variablePartPrice)
                throws XMLStreamException {
            variablePartPrice.data = OctetStringBase.hexToBytes(xml
                    .getAttribute(DATA, (String) null));

        }

        @Override
        public void write(VariablePartPriceImpl obj,
