...
public class CallAcceptedSpecificInfoImpl extends SequenceBase implements CallAcceptedSpecificInfo {
    ...
    private static final String _PrimitiveName = "callAcceptedSpecificInfo";
    ...
    protected static final XMLFormat<CallAcceptedSpecificInfoImpl> CALL_ACCEPTED_SPECIFIC_INFO_XML = new XMLFormat<CallAcceptedSpecificInfoImpl>(
        ...
        @Override
        public void read(javolution.xml.XMLFormat.InputElement xml, CallAcceptedSpecificInfoImpl oTermSeizedSpecificInfo)
                throws XMLStreamException {
            oTermSeizedSpecificInfo.locationInformation = xml.get(LOCATION_INFORMATION, LocationInformationImpl.class);
        }

        @Override
        public void write(CallAcceptedSpecificInfoImpl oTermSeizedSpecificInfo,
