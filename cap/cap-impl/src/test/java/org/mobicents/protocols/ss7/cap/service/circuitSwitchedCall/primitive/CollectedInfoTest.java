...
public class CollectedInfoTest {
    ...
    public byte[] getData1() {
        return new byte[] { (byte) 160, 24, (byte) 128, 1, 2, (byte) 129, 1, 9,
                (byte) 130, 1, 1, (byte) 133, 1, 50, (byte) 135, 1, 0,
                (byte) 136, 1, (byte) 255, (byte) 137, 1, 0, (byte) 138, 1, 0 };
    }
    ...
    public void testDecode() throws Exception {
        ...
        assertTrue(Arrays.equals(
                elem.getCollectedDigits().getEndOfReplyDigit(),
                getEndOfReplyDigit()));
        ...
        assertEquals(elem.getCollectedDigits().getErrorTreatment(),
                ErrorTreatment.stdErrorAndInfo);
    ...
    public void testEncode() throws Exception {
        ...
        CollectedDigitsImpl cd = new CollectedDigitsImpl(2, 9,
                getEndOfReplyDigit(), null, null, 50, null,
    ...
    public void testXMLSerialize() throws Exception {
        ...
        CollectedInfoImpl original = new CollectedInfoImpl(collectedDigits);
        ...
        CollectedInfoImpl copy = reader.read("collectedInfo",
