...
public class VariablePartTimeTest {
    ...
    public void testXMLSerialize() throws Exception {
        ...
        VariablePartTimeImpl original = new VariablePartTimeImpl(15, 47);
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        XMLObjectWriter writer = XMLObjectWriter.newInstance(baos);
        // writer.setBinding(binding); // Optional.
        writer.setIndentation("\t"); // Optional (use tabulation for
                                     // indentation).
        writer.write(original, "variablePartTimeImpl",
        ...
        VariablePartTimeImpl copy = reader.read("variablePartTimeImpl",
                VariablePartTimeImpl.class);
